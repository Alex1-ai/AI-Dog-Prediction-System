...
MODEL_PATH = os.path.join(BASE_DIR, 'dog', '20230710-$H221688995343-full-image-set-mobilenetv2-Adam.h5')
LABEL_PATH = os.path.join(BASE_DIR, 'dog', 'labels.csv')
load_dotenv()
...
CSRF_TRUSTED_ORIGINS = ["https://*.onrender.com", "https://dog-breed-prediction-system.onrender.com"]
...
# Add this to ignore missing files during post-processing
